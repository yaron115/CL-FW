...
KBDMode2   KBD2GameMode (NormalKeyboard, NormalKeyboard, true);
...
void initializeGame() {
    ...
    switch(currentGame) {
        ...
        case KBD2 :
            controller.current_Keymap = KBD2GameMode.current_Keymap;     break;
        default :
            break;
    }
...
void updateOutput() {
    switch(currentGame) {
        ...
        case KBD2 :
            KBD2GameMode.updateOutput(&buttonStatus);                     break;
        default :
            break;
    }   
}
